...
def fetch_trends():
    ...
    try:
        ...
        timeline_container = soup.select_one("#timeline-container > div.px-2.scroll-smooth.flex.gap-x-4.w-fit.pt-8 > div:nth-child(1)")
        ...
        if title_element:
            ...
            if timestamp_data:
                try:
                    ...
                    timestamp_text = local_time.strftime('%B %d, %Y at %I:%M %p')
